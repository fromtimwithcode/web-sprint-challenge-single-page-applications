...
- The useRouteMatch hook is used to add nested routes within an application so you only have to change a single URL parameter.

1. How would you explain form validation to someone who has never programmed before?

- Validation ensures user inputs are meeting a desginated standard (ex. email validation).

1. In 1-2 sentences, define end to end testing.

- End to end testing looks at the entire user experience from end to end. It focuses on UI and mimics how a user might interact with an app (clicks, scrolls, etc).
